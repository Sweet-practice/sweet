...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color: var(--orange);">{{ __('登録情報変更') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birth" type="text" class="form-control @error('birth') is-invalid @enderror" name="birth" value="{{ $user->birth }}" required autocomplete="birth" autofocus>
