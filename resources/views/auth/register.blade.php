            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="birth" class="col-md-4 col-form-label text-md-right">{{ __('誕生日') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('birth') is-invalid @enderror" name="address" value="{{ old('birth') }}" required autocomplete="address" autofocus>
